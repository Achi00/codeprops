  ...
  return (
    ...
    <Stack sx={{padding: "24px"}}>
      ...
      >
        ...
        <FormControl>
          <FormHelperText sx={{fontWeight: 500, margin: '10px 0', fontSize: 16, color: '#11142d'}}>Enter Website Link</FormHelperText>
          <TextareaAutosize
                minRows={5}
                required
                placeholder="Enter Description"
        ...
        <FormControl>
          <FormHelperText sx={{fontWeight: 500, margin: '10px 0', fontSize: 16, color: '#11142d'}}>Enter Github Link</FormHelperText>
          <TextareaAutosize
                minRows={5}
                required
                placeholder="Enter Description"
        ...
        <FormControl>
          <FormHelperText sx={{fontWeight: 500, margin: '10px 0', fontSize: 16, color: '#11142d'}}>Enter Head Text</FormHelperText>
          <TextareaAutosize
                minRows={5}
                required
        ...
        <FormControl>
          <FormHelperText sx={{fontWeight: 500, margin: '10px 0', fontSize: 16, color: '#11142d'}}>Enter Head Text #2</FormHelperText>
          <TextareaAutosize
                minRows={5}
                required
                placeholder="Enter Header Text"
        ...
        <FormControl>
          <FormHelperText sx={{fontWeight: 500, margin: '10px 0', fontSize: 16, color: '#11142d'}}>Enter Used Technologies</FormHelperText>
          <TextareaAutosize
                minRows={5}
                required
          ...
          <FormHelperText sx={{fontWeight: 500, margin: '10px 0', fontSize: 16, color: '#11142d'}}>Select Post Type</FormHelperText>
          <Select
          variant="outlined"
          color="info"
          displayEmpty
        ...
        <Stack direction="column" gap={1} justifyContent="center" mb={2}>
            ...
            <Typography fontSize={14} color="#808191" sx={{ wordBreak: 'break-all'}}>{postImage?.name}</Typography>
            <Typography fontSize={14} color="#808191" sx={{ wordBreak: 'break-all'}}>{postImage2?.name}</Typography>
            <Typography fontSize={14} color="#808191" sx={{ wordBreak: 'break-all'}}>{postImage3?.name}</Typography>
            <Typography fontSize={14} color="#808191" sx={{ wordBreak: 'break-all'}}>{postImage4?.name}</Typography>
        </Stack>
        <CustomButton 
              type="submit"
